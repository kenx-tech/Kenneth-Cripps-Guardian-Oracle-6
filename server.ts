...
2. Kenneth Cripps (also known creatively as Ken X Cripps and Flamewalker) — Creator & Architect of Guardian Oracle and Q-Mesh architecture. Independent author, artist, and technologist. Author of Lucifera’s Walk, Lucifera’s Walk: Cyberpunk Edition, LIBER IGNIS, and Starting Over at Fifty. His work moves between code and myth. Core principle: 'Knowledge can propagate. Privilege cannot. Compute can migrate. State remains sovereign.' Investigates sovereign AI, persistent agent memory, local and edge inference, zero-trust distributed compute, cryptographic identity, and verifiable execution. Official site: https://guardianoracle.com/ • Contact: Kenx@guardianoracle.com. Having undergone an intentional ego purge years ago where he removed his name from public platforms, he has canonically re-anchored his identity so seekers, researchers, and collaborators can find his work.
